...
# Bits for weight/activation fake quant (mirrors fake_quant.py).
parser.add_argument("--n-bits", "--n_bits", dest="n_bits", type=int, default=8)
# Dataset controls so we can evaluate other corpora (e.g., Lambada).
