...
def get_c4(nsamples, seed, seqlen, model):
    ...
    # IMPORTANT: modern HF datasets uses config "en" (not "allenai--c4")
...
def get_loaders(name, nsamples=128, seed=0, seqlen=2048, model=""):
    # Separate options (no "name:config" parsing):
    #   - wikitext2
    #   - wikitext103
    #   - ptb / ptb_new
    #   - c4  / c4_new
    ...
    raise ValueError(
        f"Unknown dataset name '{name}'. Supported: "
        f"'wikitext2', 'wikitext103', 'ptb', 'ptb_new', 'c4', 'c4_new'."
    )
